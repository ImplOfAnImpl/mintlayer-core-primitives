...
# Note: this was copied from the Mintlayer Core repository with minor modifications
...
LICENSE_TEMPLATE = [
    ...
    r'//',
    r'// https://github.com/mintlayer/mintlayer-core-primitives/blob/master/LICENSE',
    r'//',
